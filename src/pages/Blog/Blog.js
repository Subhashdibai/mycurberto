...
const posts = [
  ...
  },
  {
    ...
    title: "Best Case Study for Portfolio",
    date: "10/18/2024",
    category: "Design Tips",
  },
  {
    img: "/images/blog4.jpg",
    title: "Modern Website Animation Tricks",
    date: "10/15/2024",
    category: "Dev Source",
  },
  {
  ...
  },
  {
    ...
    title: "UI Design Process Explained",
    date: "10/10/2024",
    category: "Design Course",
  },
  {
  ...
  },
  {
    ...
    title: "How Cuberto Designs Websites",
    date: "10/06/2024",
    category: "Design Tips",
  },
    ...
    <div className="blog-page">
      ...
      <section className="blog-hero">
        ...
        <div className="blog-tabs">
          ...
          <button
            className={activeTab === "Design Course" ? "active" : ""}
            onClick={() => setActiveTab("Design Course")}
          >
            Design Course
          </button>

          <button
            className={activeTab === "Design Tips" ? "active" : ""}
            onClick={() => setActiveTab("Design Tips")}
          >
            Design Tips
          </button>

          <button
            className={activeTab === "Dev Source" ? "active" : ""}
            onClick={() => setActiveTab("Dev Source")}
          >
            Dev Source
          </button>
        </div>
